...
export function AppLogic({chatDomNode}) {
     ...
     * @param {Object} g - the audio gain node, used to control the sound
    ...
    function typer(morse, morseLetters, message, times, g, i=0, letter="", morseOut="", morseLettersOut=""){
        ...
        if(i < message.length){
            ...
            setTimeout(typer, message[i], morse, morseLetters, message, times, g, i+1, letter, morseOut, morseLettersOut)
        }
        else{
