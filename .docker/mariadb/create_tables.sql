...
CREATE TABLE IF NOT EXISTS `callsign_schemas` (
  ...
  `code_sha512` varchar(90) DEFAULT NULL,
  `code_clear` varchar(90) DEFAULT NULL,
  PRIMARY KEY (`ID`) USING HASH
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dump dei dati della tabella morsechat.callsign_schemas: ~0 rows (circa)
...
-- Dump dei dati della tabella morsechat.users: ~3 rows (circa)
